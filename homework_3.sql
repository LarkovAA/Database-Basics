...
CREATE TABLE IF NOT EXISTS repostet (
	...
	to_whom_repost BIGINT UNSIGNED, -- Я имею ввиду кому идет репост на свою стену или на стену другому человеку.
	text_repost text DEFAULT NULL, -- Вот по логике нужно что бы строчка текста или медиа кто то имел какое то значение 
